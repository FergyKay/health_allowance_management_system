...
Public Class QueryRecordSummaryReportEX
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "QueryRecordSummaryReport(EX).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "StaffHealthAllowanceProgram.QueryRecordSummaryReport(EX).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedQueryRecordSummaryReportEX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As QueryRecordSummaryReportEX = New QueryRecordSummaryReportEX()
        rpt.Site = Me.Site
        Return rpt
    End Function
