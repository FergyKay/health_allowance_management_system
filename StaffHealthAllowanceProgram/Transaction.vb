...
Public Class Transaction
    ...
    Public Sub Transaction_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub MaterialFlatButton1_Click(sender As Object, e As EventArgs) Handles MaterialFlatButton1.Click
        ...
        If (transactingHospital.SelectedItem = "" Or serviceType.SelectedItem = "" Or transactionAmount.Text = "" Or benefactorType.SelectedItem = "" Or benefactor.SelectedItem = "" Or IsNumeric(transactionAmount.Text) = False) Then
            MsgBox("Fill all fields required", MsgBoxStyle.Exclamation)
        Else
            Dim txn_date As String = txn_dateD.Value.Year & "-" & txn_dateD.Value.Month & "-" & txn_dateD.Value.Day
            Dim separators() As String = {",", ".", "!", "?", ";", ":", " "}
            ...
            Try
                If (transactionAmount.Text <= 0) Then
                ...
                Else
                    ...
                    If (benefactorType.SelectedItem = "WARD") Then
                        ...
                        Using cmd As New MySqlCommand("UPDATE " & benefactorType.SelectedItem & " SET " & benefactorType.SelectedItem & "." & serviceType.SelectedItem & " = " & benefactorType.SelectedItem & "." & serviceType.SelectedItem & " - " & (transactionAmount.Text / Home_DiffUI.conv_rate) & "  WHERE " & benefactorType.SelectedItem & "." & benefactorType.SelectedItem & "_ID LIKE'" & BenfactorID.Text & "'", SQLConnection)
